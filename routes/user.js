...
router.post('/authenticate', passport.authenticate('local', { failureRedirect: '/user/sign-in' }), userController.autheticate); // using passport middleware to authenticate
